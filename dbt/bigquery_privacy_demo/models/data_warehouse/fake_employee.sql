...
, base_info AS (
    ...
    ,data_warehouse.random_date(DATE('1920-01-01'), DATE('2005-01-01')) as date_of_birth
    ...
    ,data_warehouse.random_choice(['accounting', 'finance', 'commercial', 'operations', 'HR', 'legal', 'IT']) as department
